...
def main():
    # Read Video
    input_video_path = "input_vods/vod3.mp4"
    ...
    # Detect ball shots
    ball_shot_frames = unified_tracker.get_ball_shot_frames(detections)  # Modify this according to your ball shot logic
    ...
    save_video(output_video_frames, "./output_vods/output_video_with_unified_model.mp4")
